...
export class ProfilesController {
  ...
  async updateLocationProfile(@Body() updateData: any, @Request() req) {
    return this.profilesService.updateLocationProfile(req.user.id, updateData);
  }
  ...
  @ApiResponse({
    status: 200,
    description: "Spark profile updated successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Connect profile updated successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Forever profile updated successfully",
  })
